...
| 14  | **Landing footer placeholders** (Security, Pricing, API docs, Status, Privacy Policy, Terms; IN/TW/GH squares. "Trace verification" was removed in #51) | `/` footer                                                               | Rendered as non-link text and inert squares.                                                                                  | **Before a public deploy: Privacy Policy and Terms need real pages** (legal, not design). The rest can stay as non-links or be removed. Audit item #18 already makes their opacity consistent.                                                   |
